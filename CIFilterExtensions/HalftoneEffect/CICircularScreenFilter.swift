...
public class CICircularScreenFilter {
    ...
    public init(width: NSNumber = 6, image: CIImage, sharpness: NSNumber = 0.7, center: CIVector = CIVector(values: [150.0, 150.0], count: 2)){
        self.width = width
        self.image = image
