...
public class CIHatchedScreenFilter {
...
extension CIImage {
    ...
    public func hatchedScreenFilter(width: NSNumber = 6, sharpness: NSNumber = 0.7, center: CIVector = CIVector(values: [150.0, 150.0], count: 2), angle: NSNumber = 0) -> CIImage? {
        guard let filter = CIFilter(name: "CIHatchedScreen") else { return nil }
