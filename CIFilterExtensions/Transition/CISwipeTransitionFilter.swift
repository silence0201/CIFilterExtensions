...
public class CISwipeTransitionFilter {
    ...
    public init(width: NSNumber = 300, targetImage: CIImage, angle: NSNumber = 0, time: NSNumber = 0, color: CIColor = CIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), extent: CIVector = CIVector(values: [0.0, 0.0, 300.0, 300.0], count: 4), image: CIImage, opacity: NSNumber = 0){
        self.width = width
