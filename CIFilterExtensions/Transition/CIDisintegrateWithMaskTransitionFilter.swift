//
//  CIDisintegrateWithMaskTransitionFilter.swift
//  Demo
//
...
public class CIDisintegrateWithMaskTransitionFilter {
    ...
    public init(shadowOffset: CIVector = CIVector(values: [0.0, -10.0], count: 2), targetImage: CIImage, shadowDensity: NSNumber = 0.65, time: NSNumber = 0, maskImage: CIImage, image: CIImage, shadowRadius: NSNumber = 8){
