//
//  CIRippleTransitionFilter.swift
//  Demo
//
...
public class CIRippleTransitionFilter {
    ...
    public init(width: NSNumber = 100, targetImage: CIImage, center: CIVector = CIVector(values: [150.0, 150.0], count: 2), scale: NSNumber = 50, time: NSNumber = 0, extent: CIVector = CIVector(values: [0.0, 0.0, 300.0, 300.0], count: 4), image: CIImage, shadingImage: CIImage){
        self.width = width
