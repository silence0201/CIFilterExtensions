//
//  CIAccordionFoldTransitionFilter.swift
//  Demo
//
...
public class CIAccordionFoldTransitionFilter {
    ...
    public init(foldShadowAmount: NSNumber = 0.1, targetImage: CIImage, numberOfFolds: NSNumber = 3, image: CIImage, bottomHeight: NSNumber = 0, time: NSNumber = 0){
...
extension CIImage {
    ...
    public func accordionFoldTransitionFilter(_ foldShadowAmount: NSNumber = 0.1, targetImage: CIImage, numberOfFolds: NSNumber = 3, bottomHeight: NSNumber = 0, time: NSNumber = 0) -> CIImage? {
        guard let filter = CIFilter(name: "CIAccordionFoldTransition") else { return nil }
