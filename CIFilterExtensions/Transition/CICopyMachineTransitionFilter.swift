//
//  CICopyMachineTransitionFilter.swift
//  Demo
//
...
public class CICopyMachineTransitionFilter {
    ...
    public init(width: NSNumber = 200, targetImage: CIImage, angle: NSNumber = 0, time: NSNumber = 0, color: CIColor = CIColor(red: 0.6, green: 1.0, blue: 0.8, alpha: 1.0), extent: CIVector = CIVector(values: [0.0, 0.0, 300.0, 300.0], count: 4), image: CIImage, opacity: NSNumber = 1.3){
        self.width = width
