...
public class CIModTransitionFilter {
    ...
    public init(targetImage: CIImage, center: CIVector = CIVector(values: [150.0, 150.0], count: 2), angle: NSNumber = 2, radius: NSNumber = 150, time: NSNumber = 0, compression: NSNumber = 300, image: CIImage){
