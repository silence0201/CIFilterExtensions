...
public class CIRadialGradientFilter {
    ...
    public init(radius0: NSNumber = 5, radius1: NSNumber = 100, color0: CIColor = CIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), color1: CIColor = CIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1.0), center: CIVector = CIVector(values: [150.0, 150.0], count: 2)){
