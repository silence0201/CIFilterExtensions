//
//  CIGaussianGradientFilter.swift
//  Demo
//
...
public class CIGaussianGradientFilter {
    ...
    public init(color1: CIColor = CIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.0), color0: CIColor = CIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), center: CIVector = CIVector(values: [150.0, 150.0], count: 2), radius: NSNumber = 300){
        self.color1 = color1
        self.color0 = color0
        self.center = center
        self.radius = radius
