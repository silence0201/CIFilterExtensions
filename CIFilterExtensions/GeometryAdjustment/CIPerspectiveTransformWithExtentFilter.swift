//
//  CIPerspectiveTransformWithExtentFilter.swift
//  Demo
//
...
public class CIPerspectiveTransformWithExtentFilter {
    ...
    public init(topRight: CIVector = CIVector(values: [646.0, 507.0], count: 2),
                image: CIImage,
                bottomRight: CIVector = CIVector(values: [548.0, 140.0], count: 2),
                topLeft: CIVector = CIVector(values: [118.0, 484.0], count: 2),
                bottomLeft: CIVector = CIVector(values: [155.0, 153.0], count: 2),
                extent: CIVector = CIVector(values: [0.0, 0.0, 300.0, 300.0],
                 count: 4)){
...
extension CIImage {
    ...
    public func perspectiveTransformWithExtentFilter(topRight: CIVector = CIVector(values: [646.0, 507.0], count: 2),
                                                     bottomRight: CIVector = CIVector(values: [548.0, 140.0], count: 2),
                                                     topLeft: CIVector = CIVector(values: [118.0, 484.0], count: 2),
                                                     bottomLeft: CIVector = CIVector(values: [155.0, 153.0], count: 2),
                                                     extent: CIVector = CIVector(values: [0.0, 0.0, 300.0, 300.0], count: 4)) -> CIImage? {
        guard let filter = CIFilter(name: "CIPerspectiveTransformWithExtent") else { return nil }
