//
//  CIStarShineGeneratorFilter.swift
//  Demo
//
...
public class StarShineGenerator {
    ...
    public init(center: CIVector = CIVector(values: [150.0, 150.0], count: 2), epsilon: NSNumber = -2, radius: NSNumber = 50, color: CIColor = CIColor(red: 1.0, green: 0.8, blue: 0.6, alpha: 1.0), crossScale: NSNumber = 15, crossWidth: NSNumber = 2.5, crossAngle: NSNumber = 0.6, crossOpacity: NSNumber = -2){
        self.center = center
