//
//  CISunbeamsGeneratorFilter.swift
//  Demo
//
...
public class SunbeamsGenerator {
    ...
    public init(sunRadius: NSNumber = 40, striationStrength: NSNumber = 0.5, center: CIVector = CIVector(values: [150.0, 150.0], count: 2), maxStriationRadius: NSNumber = 2.58, time: NSNumber = 0, color: CIColor = CIColor(red: 1.0, green: 0.5, blue: 0.0, alpha: 1.0), striationContrast: NSNumber = 1.375){
