//
//  CILenticularHaloGeneratorFilter.swift
//  Demo
//
...
public class CILenticularHaloGeneratorFilter {
    ...
    public init(haloOverlap: NSNumber = 0.77, striationStrength: NSNumber = 0.5, center: CIVector = CIVector(values: [150.0, 150.0], count: 2), time: NSNumber = 0, color: CIColor = CIColor(red: 1.0, green: 0.9, blue: 0.8, alpha: 1.0), striationContrast: NSNumber = 1, haloWidth: NSNumber = 87, haloRadius: NSNumber = 70){
