//
//  CICheckerboardGeneratorFilter.swift
//  Demo
//
...
public class CICheckerboardGeneratorFilter {
    ...
    public init(width: NSNumber = 80, color1: CIColor = CIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1.0), color0: CIColor = CIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), sharpness: NSNumber = 1, center: CIVector = CIVector(values: [150.0, 150.0], count: 2)){
        self.width = width
        self.color1 = color1
        self.color0 = color0
