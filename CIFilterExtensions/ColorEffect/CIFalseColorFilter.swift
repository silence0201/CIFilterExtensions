...
public class CIFalseColorFilter {
    ...
    public init(image: CIImage, color0: CIColor = CIColor(red: 0.3, green: 0.0, blue: 0.0, alpha: 1.0), color1: CIColor = CIColor(red: 1.0, green: 0.9, blue: 0.8, alpha: 1.0)){
        self.image = image
        self.color0 = color0
        self.color1 = color1
    }
