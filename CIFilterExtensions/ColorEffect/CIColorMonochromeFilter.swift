...
public class CIColorMonochromeFilter {
    
    public var intensity: NSNumber = 1
    public var image: CIImage
    public var color: CIColor = CIColor(red: 0.6, green: 0.45, blue: 0.3, alpha: 1.0)
    
    public init(intensity: NSNumber = 1, image: CIImage, color: CIColor = CIColor(red: 0.6, green: 0.45, blue: 0.3, alpha: 1.0)){
