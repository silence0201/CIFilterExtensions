...
public class CIAreaAverageFilter {
...
extension CIImage {
    ...
    public func areaAverageFilter(extent: CIVector = CIVector(values: [0.0, 0.0, 640.0, 80.0], count: 4)) -> CIImage? {
        guard let filter = CIFilter(name: "CIAreaAverage") else { return nil }
