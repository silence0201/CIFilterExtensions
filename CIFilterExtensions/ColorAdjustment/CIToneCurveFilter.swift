...
public class CIToneCurveFilter {
    ...
    public init(point1: CIVector = CIVector(values: [0.25, 0.25], count: 2), image: CIImage, point3: CIVector = CIVector(values: [0.75, 0.75], count: 2), point2: CIVector = CIVector(values: [0.5, 0.5], count: 2), point0: CIVector = CIVector(values: [0.0, 0.0], count: 2), point4: CIVector = CIVector(values: [1.0, 1.0], count: 2)){
        self.point1 = point1
        self.image = image
        self.point3 = point3
        self.point2 = point2
