...
public class CIDrosteFilter {
    ...
    public init(rotation: NSNumber = 0,
                strands: NSNumber = 1,
                periodicity: NSNumber = 1,
                insetPoint1: CIVector = CIVector(values: [400.0, 400.0], count: 2),
                image: CIImage,
                insetPoint0: CIVector = CIVector(values: [200.0, 200.0], count: 2),
                zoom: NSNumber = 1){
...
extension CIImage {
    ...
    public func drosteFilter(rotation: NSNumber = 0,
                             strands: NSNumber = 1,
                             periodicity: NSNumber = 1,
                             insetPoint1: CIVector = CIVector(values: [400.0, 400.0], count: 2),
                             insetPoint0: CIVector = CIVector(values: [200.0, 200.0], count: 2),
                             zoom: NSNumber = 1) -> CIImage? {
        guard let filter = CIFilter(name: "CIDroste") else { return nil }
