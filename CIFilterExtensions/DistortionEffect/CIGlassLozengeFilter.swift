...
public class CIGlassLozengeFilter {
    ...
    public init(point1: CIVector = CIVector(values: [350.0, 150.0], count: 2),
                image: CIImage, refraction: NSNumber = 1.7,
                radius: NSNumber = 100,
                point0: CIVector = CIVector(values: [150.0, 150.0], count: 2)){
        self.point1 = point1
        self.image = image
...
extension CIImage {
    ...
    public func glassLozengeFilter(point1: CIVector = CIVector(values: [350.0, 150.0], count: 2),
                                   refraction: NSNumber = 1.7,
                                   radius: NSNumber = 100,
                                   point0: CIVector = CIVector(values: [150.0, 150.0], count: 2)) -> CIImage? {
        guard let filter = CIFilter(name: "CIGlassLozenge") else { return nil }
