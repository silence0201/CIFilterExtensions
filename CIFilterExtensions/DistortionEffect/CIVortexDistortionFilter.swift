//
//  CIVortexDistortionFilter.swift
//  Demo
//
...
public class CIVortexDistortionFilter {
...
extension CIImage {
    ...
    public func vortexDistortionFilter(center: CIVector = CIVector(values: [150.0, 150.0], count: 2),
                                       angle: NSNumber = 56.54866776461628,
