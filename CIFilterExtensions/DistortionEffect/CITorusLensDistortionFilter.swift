//
//  CITorusLensDistortionFilter.swift
//  Demo
//
...
public class CITorusLensDistortionFilter {
    ...
    public init(width: NSNumber = 80,
                image: CIImage, center: CIVector = CIVector(values: [150.0, 150.0], count: 2),
...
extension CIImage {
    ...
    public func torusLensDistortionFilter(width: NSNumber = 80,
                                          center: CIVector = CIVector(values: [150.0, 150.0], count: 2),
                                          refraction: NSNumber = 1.7,
                                          radius: NSNumber = 160) -> CIImage? {
        guard let filter = CIFilter(name: "CITorusLensDistortion") else { return nil }
