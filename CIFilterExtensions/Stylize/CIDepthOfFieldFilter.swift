...
public class CIDepthOfFieldFilter {
    ...
    public init(point0: CIVector = CIVector(values: [0.0, 300.0], count: 2), radius: NSNumber = 6, point1: CIVector = CIVector(values: [300.0, 300.0], count: 2), image: CIImage, saturation: NSNumber = 1.5, unsharpMaskRadius: NSNumber = 2.5, unsharpMaskIntensity: NSNumber = 0.5){
        self.point0 = point0
        self.radius = radius
        self.point1 = point1
        self.image = image
