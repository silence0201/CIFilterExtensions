...
public class CIKaleidoscopeFilter {
    ...
    public init(count: NSNumber = 6, image: CIImage, center: CIVector = CIVector(values: [150.0, 150.0], count: 2), angle: NSNumber = 0){
        self.count = count
        self.image = image
        self.center = center
        self.angle = angle
