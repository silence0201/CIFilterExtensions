//
//  CIGlideReflectedTileFilter.swift
//  Demo
//
...
public class CIGlideReflectedTileFilter {
...
extension CIImage {
    ...
    public func glideReflectedTileFilter(width: NSNumber = 100, center: CIVector = CIVector(values: [150.0, 150.0], count: 2), angle: NSNumber = 0) -> CIImage? {
        guard let filter = CIFilter(name: "CIGlideReflectedTile") else { return nil }
