//
//  CITriangleKaleidoscopeFilter.swift
//  Demo
//
...
public class TriangleKaleidoscope {
    ...
    public init(size: NSNumber = 700, image: CIImage, rotation: NSNumber = 5.924285296593801, decay: NSNumber = 0.85, point: CIVector = CIVector(values: [150.0, 150.0], count: 2)){
        self.size = size
        self.image = image
