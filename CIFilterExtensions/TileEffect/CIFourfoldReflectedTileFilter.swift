//
//  CIFourfoldReflectedTileFilter.swift
//  Demo
//
...
public class CIFourfoldReflectedTileFilter {
...
extension CIImage {
    ...
    public func fourfoldReflectedTileFilter(width: NSNumber = 100, acuteAngle: NSNumber = 1.570796326794897, center: CIVector = CIVector(values: [150.0, 150.0], count: 2), angle: NSNumber = 0) -> CIImage? {
        guard let filter = CIFilter(name: "CIFourfoldReflectedTile") else { return nil }
